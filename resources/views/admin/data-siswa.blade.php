            ...
            @foreach ($siswa as $index => $sis)
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="/admin/siswa/delete/{{ $sis->id }}" class="btn btn-sm btn-danger m-0 @if($sis->aspirasi->count() > 0)disabled @endif" style="box-shadow: none !Important" onclick="return confirm('Yakin Data ini akan dihapus')">
