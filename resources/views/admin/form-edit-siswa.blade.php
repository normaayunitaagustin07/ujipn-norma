        ...
        <div class="col-19 p-3">
            ...
            <form action="{{ route('admin.edit-siswa') }}" method="POST">
                ...
                <div class="form-group row mb-3 align-items-center">
                    ...
                    <div class="col-9">
                        <input type="text" name="nama" class="form-control @error('nama')is-invalid @enderror" placeholder="Nama Siswa..." value="{{ $siswa->siswa }}"> 
                        @error('nama')
                ...
                <div class="form-group row mb-3 align-items-center">
                    ...
                    <div class="col-9">
                        <input type="email" name="email" class="form-control @error('email')is-invalid @enderror" placeholder="Nama Email..." value="{{ $siswa->email }}"> 
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>          
                ...
                <div class="form-group row mb-3 align-items-center">
                    ...
                    <div class="col-9">
                        <input type="text" name="nis" class="form-control @error('nis')is-invalid @enderror" placeholder="Nomor Induk Nis..." value="{{ $siswa->nis }}"
                        @error('nis')> 
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>          
                ...
                <div class="form-group row mb-3 align-items-center">
                    ...
                    <div class="col-9">
                        <select name="kelas" class="form-control @error('kelas')is-invalid @enderror">
                            ...
                            <option value="12 AKL" {{ $siswa->kelas == '10 AKL' ? 'selected' : '' }}>12 AKL</option>
                ...
                <div class="form-group row mb-3 align-items-center">
                    ...
                    <div class="col-9">
                        <select name="jurusan" class="form-control @error('jurusan')is-invalid @enderror">
                            ...
                            <option value="PMS"{{ $siswa->jurusan == 'ULP' ? 'selected' : '' }}>PMS</option>
                            <option value="PMS"{{ $siswa->jurusan == 'BR' ? 'selected' : '' }}>PMS</option>
                        </select>
                        @error('jurusan')
                            <div class="invalid-feedback">
                                {{ $message }}
