        ...
        <div class="box shadow p-5">
            ...
            <form action="{{ route('siswa.proses-tambah') }}" method="POST">
                ...
                <div class="row mb-3 d-flex align-items-center">
                    ...
                    <div class="col-9">
                        <input class="form-control @error('judul_id') is-invalid @enderror" type="text" name="judul" id="judul" >
                         @error('judul')
                        <div class="invalid-fedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-3 d-flex align-items-center">
                    ...
                    <div class="col-9">
                    <textarea name="isi" id="" rows="10" class="form-control @error('isi_id') is-invalid @enderror"></textarea>
                    @error('isi')
                        <div class="invalid-fedback">
                            {{ $message }}
                        </div>
